        ...
        child: Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              hr,
              _buildIconTile(Icons.account_circle, Colors.purpleAccent, 'Groups'),
            ],
          ),
        ),
      ),
        ...
        child: Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              hr,
              _buildIconTile(Icons.supervised_user_circle, Colors.orangeAccent, 'Find Friends'),
              hr,
              _buildIconTile(Icons.account_circle, Colors.black, 'Blacklist'),
              hr,
              _buildIconTile(Icons.settings, Colors.grey.withOpacity(0.6), 'Settings'),
            ],
          ),
        ),
      ),
